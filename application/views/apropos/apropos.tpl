...
<p>Lors  de  la  journée  Cheikh  Ahmadou  Bamba  le  1  aout  2015  à  Montréal,  Serigne  Moustapha  Gaindé  Fatma Mbacké s’est interrogé 
: 
...
<ul><li>
 ...
 la communauté mouride </li>
    <li>
 Appuyer le développement de projets éducatifs 
    </li>
    <li>
 Former une plateforme d’échange de savoir entre les savants mourides 
    </li>
    <li>
 Former un forum de discussions sur l’actualité mouride et les projets en cours 
    </li>
</ul></p>
<p>Vous pouvez vous inscrire très facilement en allant à la
 rubrique devenir membre du site internet de RPM 
 www.rp2m.com </p>
<p>Nous espérons vos précieuses contributions.<br/> 
    Toute l’équipe tient à vous remercier tous de votre implications.</p>
<br/>
<h4> Plan d'execution</h4>
<hr>
