...
<div class="container">
     <div class="panel panel-default">
				  <div class="panel-heading">
					<h3 class="panel-title">Éditer ce service</h3>
				  </div>
                                    <div class="panel-body" > 
<form method="post" enctype="multipart/form-data">
    <div class="input-group input-group-lg">
        <label class="bg-label">Nom *:</label>
        <input class='required form-control' type="text" name="name"  placeholder="Nom du service" value="{$service->getTitre()}">
    </div>
     <div class="input-group input-group-lg">
        <label class="bg-label">Description *:</label>
	<textarea  rows="4" id="mytextareaAccueil1" name="description">{$service->getDescription()}</textarea>
     </div>
    <div id='domaine'>
       {foreach from=$domaines item=domaine}
            <div class="input-group input-group-lg">
                <label class="bg-label">Domaine :</label>
                <input id="" type="text" name="domaine[]" class="form-control" placeholder="domaine" value="{$domaine->getTitre()}">
             </div>
             <div class="input-group input-group-lg">
                <label class="bg-label">Description *:</label>
                <textarea  rows="4" id="domaine1" name="descd[]">{$domaine->getDescription()}</textarea>
             </div>
       {/foreach}
    </div>
    <br/>
